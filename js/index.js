...
/*
  ...
  Original by Kenneth Cachia
  This Index file has been edited by Marvin R.
*/
...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('Shape|Shifter|Plus|SS+|Schreiben|zum starten|/reck|/down 3||');
    }
  ...
  function performAction(value) {
    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        default:
          S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? 'Wie bitte?' : current));
      }
